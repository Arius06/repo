(() => {
  ...
  const ru = {
    ...
    "about.productJourney.stage2.text":
      "Закупка сырья осуществляется на основании договоров поставки после отбора и оценки поставщиков в соответствии с требованиями действующего законодательства. Сырье животного происхождения отечественного производства допускается к переработке только после проведения ветеринарно-санитарного контроля, при условии его получения на авторизованных предприятиях, в соответствии с требованиями ANSA, а также если оно получено от животных, идентифицированных и маркированных ветеринарным врачом знаком здоровья/соответствия, содержащим номер разрешения предприятия происхождения, который также должен быть указан в сопроводительных документах: ветеринарно-санитарном сертификате, выданном ANSA, и сертификатах качества, подтверждающих происхождение, качество и безопасность продукции, выданных производителем. Импортное сырье принимается на основании соглашений об эквивалентности, заключенных с компетентными органами страны-экспортера, и сопровождается ветеринарно-санитарным сертификатом, признанным в национальной системе. Приемка каждой партии сырья и/или вспомогательных материалов осуществляется в соответствии с действующими нормативами по показателям качества и безопасности пищевых продуктов, включая визуальную и органолептическую оценку (цвет, запах, текстура), проверку соответствия сопроводительным документам, условий хранения, сроков годности и целостности упаковки.",
    ...
    "members.title": "Члены Совета директоров",
    "members.subtitle":
